...
public class IfDemo5 {
	...
	public static void main(String[] args) {
		 ...
		 * 
		 * 		빠른 종료는 제시된 조건을 기준으로 조건에 부합되지 않는 나쁜 경우를 먼저 찾아서 프로그램의 실행을 중단시키는 것이다.
		 * 			빠른 종료는 return 키워드나 throw 키워드를 이용해서 나쁜 경우를 만나면 프로그램의 실행을 즉시 중단 시킨다.
		 * 			빠른 종료를 활용하면 if문의 구조를 단순화시킬 수 있고, 다양한 조건을 내포된 if문 없이 작성할 수 있다.
		...
		// 국어 영어 수학 점수 성적으로 합격 불합격 여부를 판정한다.
		// 평균 60점 이상이면 합격, 미만이면 불합격이다.
		// 국어 영어 수학 과목 중에서 한 과목이라도 40점 미만이면 불합격이다.
